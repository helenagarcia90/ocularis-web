...
$this->pageTitle=Yii::t('contact', 'Contact me');

$this->breadcrumbs=array(
	Yii::t('contact', 'Contact me')
);
?>

<h1><?=Yii::t('contact', 'Contact me')?></h1>
...
$form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group captcha">
		...
		<p class="help-block"><?= Yii::t('form', 'Please enter the letters as they are shown in the image above.');?></p>

...
<div class="row">
	...
	<div class="col-lg-10">
				...
				$form->fieldGroup('selector', $model, 'id_page_parent', 
							array(
									'displayValue' => CHtml::value($model, "parent.title",''),
									'url' => $this->createUrl('selector', $model->isNewRecord ? array() : array('filters' => array('id_page' => '<>'.$model->id_page)) ),
									'label-col' => 'col-lg-12',
									'input-col' => 'col-lg-12'
	...
	<div class="col-lg-2">
				...
				{
					$form->fieldGroup('dropDownList', $model, 'lang', array('data' => Lang::getListData(), 'label-col' => 'col-lg-12', 'input-col' => 'col-lg-12' ));
				}
				
				 
				//Yii::t('page', '- Select Category -')

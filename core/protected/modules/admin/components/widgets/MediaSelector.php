...
class MediaSelector extends CInputWidget
{
	...
	public function run(){
		...
		if($this->hasModel())
			$image = Yii::app()->imageCache->createUrl('msthumb', CHtml::resolveValue($this->model, $this->attribute));
		else
			$image = Yii::app()->imageCache->createUrl('msthumb', $this->value);
	...
	private function registerScript()
	{
		...
		'callback' => "js:function(url) {
								...
								thumb = url.replace('/medias/images/','/medias/".Yii::app()->imageCache->cacheDir."/msthumb/');
